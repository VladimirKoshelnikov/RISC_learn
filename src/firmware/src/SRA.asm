...
_boot:                    /* x0  = 0    0x000 */
    ...
    sra x2  , x2,  x1   /* x1  = 0b11111111110 */
    sra x3  , x3,  x1   /* x1  = 0b01010101010 */
    sra x4  , x4,  x1   /* x1  = 0b11000011110 */
    sra x5  , x5,  x1   /* x1  = 0b00111100000 */
    sra x6  , x6,  x1   /* x1  = 0b10011001100 */
    sra x7  , x7,  x1   /* x1  = 0b01100110010 */
    sra x8  , x8,  x1   /* x1  = 0b11111000000 */
    sra x9  , x9,  x1   /* x1  = 0b00000111110 */
